/**
 * PIE Color utilities for Svelte components
 * Mirrors @pie-lib/render-ui color.ts to maintain styling consistency
 */

// Material UI color values (matching React version)
const green = { 50: '#e8f5e9', 500: '#4caf50' };
const indigo = { 200: '#9fa8da', 500: '#3f51b5', 800: '#283593' };
const orange = { 500: '#ff9800' };
const pink = { 200: '#f48fb1', 900: '#880e4f', A400: '#f50057' };
const red = { 50: '#ffebee', 700: '#d32f2f' };
...
/**
 * Creates CSS variable references with fallback chain
 * @param prefix - CSS variable prefix (e.g., 'pie')
 */
export const v =
  (prefix: string) =>
  (...args: string[]) => {
    const fallback = args.pop() as string;
