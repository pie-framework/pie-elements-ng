...
```bash
bun add @pie-element/math-rendering-katex
```
...
```typescript
import { renderMath } from '@pie-element/math-rendering-katex';
...
```typescript
import { wrapMath, unWrapMath } from '@pie-element/math-rendering-katex';
...
- `@pie-element/math-rendering` - Core types and utilities
- `@pie-element/shared-mathml-to-latex` - MathML conversion
