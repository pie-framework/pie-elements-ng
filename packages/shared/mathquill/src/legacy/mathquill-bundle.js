...
if (!jQuery) throw 'MathQuill requires jQuery to be passed as parameter';
 ...
 *   sendMethod(obj2, 4); // => 6
 */
var send = variadic((method, args) => variadic((obj, moreArgs) => {
...
(() => {
  var mostOps = (
    'arg deg det dim exp gcd hom inf ker lg ln log max min sup' + ' limsup liminf injlim projlim Pr'
  ).split(' ');
