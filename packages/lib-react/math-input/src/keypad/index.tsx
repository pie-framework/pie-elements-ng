...
import { commonMqKeyboardStyles } from '../mq/common-mq-styles.js';
import { sortKeys } from './keys-layout.js';
...
const KeyPadContainer: any = styled('div')(() => ({
...
const StyledButton: any = styled(Button)(({ category, isDelete, isComma, isDot }) => ({
  minWidth: 'auto',
  textTransform: 'none',
...
const StyledLatexButtonWrapper: any = styled(Button)(({ category }) => ({
  textTransform: 'none',
  padding: 0,
  margin: 0,
