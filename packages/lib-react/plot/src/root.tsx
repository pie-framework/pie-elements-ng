...
const GraphTitle: any = styled('div')(({ theme }) => ({
  color: color.defaults.TEXT,
...
const TopPixelIndicator: any = styled('div')({
  display: 'flex',
...
const SidePixelGuides: any = styled('div')({
  width: '70px',
  display: 'flex',
  flexDirection: 'column',
  marginRight: '6px',
...
const SidePixelIndicator: any = styled('div')({
  textAlign: 'right',
  height: '20px',
  pointerEvents: 'none',
  userSelect: 'none',
