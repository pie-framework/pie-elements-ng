    ...
    rollupOptions: {
      external: (id) => {
        return (
          ...
          ['prop-types','classnames','debug','i18next','humps','react-jss','js-combinatorics','@mapbox/point-geometry','react-transition-group','nested-property','pluralize','decimal.js'].includes(id)
        );
      },
      output: {
