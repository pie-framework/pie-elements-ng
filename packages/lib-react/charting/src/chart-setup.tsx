...
const StyledContent: any = styled('div')(({ theme }) => ({
  display: 'flex',
...
const StyledColumnView: any = styled('div')(() => ({
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
}));

const StyledRowView: any = styled('div')(() => ({
  display: 'flex',
  justifyContent: 'space-around',
  alignItems: 'center',
}));

const StyledTextField: any = styled(NumberTextFieldCustom)(({ theme }) => ({
  width: '130px',
  margin: `${theme.spacing(1)} ${theme.spacing(0.5)}`,
}));

const StyledMediumTextField: any = styled(NumberTextFieldCustom)(({ theme }) => ({
  width: '160px',
  margin: `${theme.spacing(1)} ${theme.spacing(0.5)}`,
}));

const StyledDimensions: any = styled('div')(({ theme }) => ({
  display: 'flex',
...
const StyledDisabled: any = styled(Typography)(() => ({
