...
| **Verdaccio** | The local npm registry (Docker-based) used to publish and validate element packages in a production-like ESM environment before pushing to real npm | Local registry, dev registry |
